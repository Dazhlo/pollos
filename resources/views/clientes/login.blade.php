...
<body class="bg-white">
    ...
    <nav class="absolute top-0 border-solid border-gray-200 w-full border-b py-3 z-50">
            ...
            <div class="w-full flex flex-col lg:flex-row">
                <div class="flex justify-between lg:flex-row">
                    <a href="/menu" class="flex items-center">
                        ...
                        <span class="self-center text-2xl font-semibold whitespace-nowrap text-black">Pollos locos</span>
                    </a>
                </div>
            </div>
        </div>
    ...
    <ul class="p-8 flex items-center justify-center gap-2 flex-col bg-white rounded-xl">
        <h3 class="text-gray-900 text-4xl font-extrabold md:text-5xl lg:text-6xl">
            Iniciar <span class="text-transparent bg-clip-text bg-gradient-to-r to-indigo-600 from-violet-400">Seccion</span>
        </h3>
    </ul>
