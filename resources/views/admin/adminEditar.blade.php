	...
	<form action="/admin/update/{{$Platillo->id}}" method ="POST"  enctype="multipart/form-data"  class=""> 
		@csrf
		@method('PUT')
							...
							<div class="mb-4 md:flex md:justify-between">
								<div class="mb-4 md:mr-2 md:mb-0">
									...
									<input
										...
										type="text"
										placeholder="Nombre del platillo" value="{{$Platillo->nombre_platillo}}"
									/>
								</div>
								{{-- precio del platillo  --}}
								<div class="md:ml-2">
									...
									<input
									   ...
									   name="precio" id="precio"
										type="text"
										placeholder="precio" value="{{$Platillo->precio_unitario}}"
									/>
								...
								<div class="md:ml-2">
									...
									<input
									   ...
									   name="stock" id="stock"
										type="text"
										placeholder="stock" value=" {{$Platillo->stock}}" 
									/>
							...
							<div class="mb-4">
								...
								<input
								   ...
								   for="detalles" name="detalles"
									type="detalles"
									placeholder="detalles del pedido" value = " {{$Platillo->detalle_platillo}}"
								/>
							</div>
							<div class="mb-4 md:flex md:justify-between">
