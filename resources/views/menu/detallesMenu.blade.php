            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 mx-auto max-md:px-2 ">
                ...
                <div
                    ...
                    <div class="data w-full max-w-xl">
                        <p class="text-lg font-medium leading-8 text-indigo-600 mb-4">Menu&nbsp; /&nbsp; Detalles
                        </p>
                        {{-- Nombre del articulo --}}
                        <h2 class="font-manrope font-bold text-3xl leading-10 text-gray-900 mb-2 capitalize"> {{$Platillo->nombre_platillo}}
                        </h2>
                        ...
                        <p class="text-gray-500 text-base font-normal mb-5">
                            {{$Platillo->detalle_platillo}} <a href="#"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <form action="">
                                ...
                                <input type="hidden" name="name" value="{{ $Platillo->nombre_platillo }}">
                                <input type="hidden" name="price" value="{{ $Platillo->precio_unitario }}">
                                {{-- <input type="hidden" name="image" value="{{ $Platillo->image }}"> --}}
                                <input type="hidden" name="quantity" value="1">
                                <input type="hidden" name="description" value="{{ $Platillo->detalle_platillo }}">
                            <button type="submit"
